...
//go:generate minimock -i github.com/drewspitsin/auth/internal/service.AuthService -o ./mocks/auth_service_minimock.go -n AuthServiceMock
...
func (mmCreate *mAuthServiceMockCreate) Expect(ctx context.Context, info *model.UserCreate) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Inspect(f func(ctx context.Context, info *model.UserCreate)) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Set(f func(ctx context.Context, info *model.UserCreate) (i1 int64, err error)) *AuthServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthServiceMockCreate) When(ctx context.Context, info *model.UserCreate) *AuthServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *AuthServiceMock) Create(ctx context.Context, info *model.UserCreate) (i1 int64, err error) {
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, info *model.UserUpdate) *mAuthServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthServiceMockUpdateParams{ctx, info}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, info *model.UserUpdate)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, info *model.UserUpdate) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, info *model.UserUpdate) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &AuthServiceMockUpdateParams{ctx, info},
	}
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, info *model.UserUpdate) (err error) {
	...
	mm_params := &AuthServiceMockUpdateParams{ctx, info}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockUpdateParams{ctx, info}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthServiceMock.Update. %v %v", ctx, info)
	return
}
