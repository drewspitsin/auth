...
//go:generate minimock -i github.com/drewspitsin/auth/internal/repository.AuthRepository -o ./mocks/auth_repository_minimock.go -n AuthRepositoryMock
...
type AuthRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, info *model.UserCreate) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, info *model.UserCreate)
	...
	funcGet          func(ctx context.Context, userTableID int64) (up1 *model.User, err error)
	inspectFuncGet   func(ctx context.Context, userTableID int64)
	afterGetCounter  uint64
	beforeGetCounter uint64
	GetMock          mAuthRepositoryMockGet

	funcUpdate          func(ctx context.Context, info *model.UserUpdate) (err error)
	inspectFuncUpdate   func(ctx context.Context, info *model.UserUpdate)
...
func (mmCreate *mAuthRepositoryMockCreate) Expect(ctx context.Context, info *model.UserCreate) *mAuthRepositoryMockCreate {
...
func (mmCreate *mAuthRepositoryMockCreate) Inspect(f func(ctx context.Context, info *model.UserCreate)) *mAuthRepositoryMockCreate {
...
func (mmCreate *mAuthRepositoryMockCreate) Set(f func(ctx context.Context, info *model.UserCreate) (i1 int64, err error)) *AuthRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthRepositoryMockCreate) When(ctx context.Context, info *model.UserCreate) *AuthRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *AuthRepositoryMock) Create(ctx context.Context, info *model.UserCreate) (i1 int64, err error) {
...
func (mmGet *mAuthRepositoryMockGet) Expect(ctx context.Context, userTableID int64) *mAuthRepositoryMockGet {
	...
	mmGet.defaultExpectation.params = &AuthRepositoryMockGetParams{ctx, userTableID}
...
func (mmGet *mAuthRepositoryMockGet) Inspect(f func(ctx context.Context, userTableID int64)) *mAuthRepositoryMockGet {
...
func (mmGet *mAuthRepositoryMockGet) Set(f func(ctx context.Context, userTableID int64) (up1 *model.User, err error)) *AuthRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mAuthRepositoryMockGet) When(ctx context.Context, userTableID int64) *AuthRepositoryMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthRepositoryMock.Get mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockGetExpectation{
		mock:   mmGet.mock,
		params: &AuthRepositoryMockGetParams{ctx, userTableID},
	}
...
func (mmGet *AuthRepositoryMock) Get(ctx context.Context, userTableID int64) (up1 *model.User, err error) {
	mm_atomic.AddUint64(&mmGet.beforeGetCounter, 1)
	defer mm_atomic.AddUint64(&mmGet.afterGetCounter, 1)

	if mmGet.inspectFuncGet != nil {
		mmGet.inspectFuncGet(ctx, userTableID)
	}

	mm_params := &AuthRepositoryMockGetParams{ctx, userTableID}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockGetParams{ctx, userTableID}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGet.funcGet != nil {
		return mmGet.funcGet(ctx, userTableID)
	}
	mmGet.t.Fatalf("Unexpected call to AuthRepositoryMock.Get. %v %v", ctx, userTableID)
	return
}
...
func (mmUpdate *mAuthRepositoryMockUpdate) Expect(ctx context.Context, info *model.UserUpdate) *mAuthRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthRepositoryMockUpdateParams{ctx, info}
...
func (mmUpdate *mAuthRepositoryMockUpdate) Inspect(f func(ctx context.Context, info *model.UserUpdate)) *mAuthRepositoryMockUpdate {
...
func (mmUpdate *mAuthRepositoryMockUpdate) Set(f func(ctx context.Context, info *model.UserUpdate) (err error)) *AuthRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthRepositoryMockUpdate) When(ctx context.Context, info *model.UserUpdate) *AuthRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &AuthRepositoryMockUpdateParams{ctx, info},
	}
...
func (mmUpdate *AuthRepositoryMock) Update(ctx context.Context, info *model.UserUpdate) (err error) {
	...
	mm_params := &AuthRepositoryMockUpdateParams{ctx, info}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockUpdateParams{ctx, info}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthRepositoryMock.Update. %v %v", ctx, info)
	return
}
