...
//go:generate minimock -i github.com/drewspitsin/auth/internal/client/db.QueryExecer -o ./mocks/query_execer_minimock.go -n QueryExecerMock
...
import (
	...
	mm_db "github.com/drewspitsin/auth/internal/client/db"
