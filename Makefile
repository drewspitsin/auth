...
generate-user-api:
	...
	protoc --proto_path api/user_api --proto_path vendor.protogen \
	...
	api/user_api/user_api_v1.proto

build:
	GOOS=linux GOARCH=amd64 go build -o service_linux cmd/main.go

copy-to-server:
	scp service_linux root@89.104.117.12:
...
test:
	go clean -testcache
	go test ./... -covermode count -coverpkg=github.com/drewspitsin/auth/internal/service/...,github.com/drewspitsin/auth/internal/api/... -count 5

test-coverage:
	go clean -testcache
	go test ./... -coverprofile=coverage.tmp.out -covermode count -coverpkg=github.com/drewspitsin/auth/internal/service/...,github.com/drewspitsin/auth/internal/api/... -count 5
